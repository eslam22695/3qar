            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class=" main-btn-00">
                        <!-- Responsive modal -->
                        <button type="button" class="btn btn-default waves-effect" data-toggle="modal" data-target="#add">اضافة طلب خدمة+</button>
                        ...
                        @if(isset($families))
                            @foreach($families as $family)
                                <tr>
                                    ...
                                    <td class="actions">
                                     <a href="{{ route('admin.status',[$family->status,'option_groups',$family->id]) }}" class="btn btn-{{$family->status == 1 ? 'secondary' : 'dark'}} waves-effect" title="الحالة"> {{$family->status == 1 ? 'إبطال' : 'تفعيل'}}</a>
