                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="example-input-large" name="name" class="form-control input-lg" required>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="example-input-large" name="price" class="form-control input-lg" required>
                                            @if ($errors->has('price'))
                                                <span class="alert alert-danger">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="example-input-large" name="area" class="form-control input-lg" required>
                                            @if ($errors->has('area'))
                                                <span class="alert alert-danger">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="example-input-large" name="phone" class="form-control input-lg" required min="0">
                                            @if ($errors->has('phone'))
                                                <span class="alert alert-danger">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" checked data-plugin="switchery" data-color="#81c868" name="featured" value="1"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
