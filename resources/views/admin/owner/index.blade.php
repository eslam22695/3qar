            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class=" main-btn-00">
                        <!-- Responsive modal -->
                        <a href="{{ route('admin.owner.create') }}" class="btn btn-default waves-effect">اضافه مالك  +</a>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @if(isset($owners))
                            @foreach($owners as $owner)
                                ...
                                <div id="{{$owner->id}}delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog" style="width:55%;">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer" style="text-align:center">
                                                <form action="{{action('admin\OwnerController@destroy', $owner['id'])}}" method="post">
                                                    {{csrf_field()}}
                ...
                <div class="col-sm-12">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td><button type="submit" class="btn btn-default waves-effect waves-light form-control">عرص العقار </button></td>
                        </tr>
                        </tbody>
