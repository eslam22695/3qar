                        ...
                        <div id="add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    {{Form::open(['method'=>'POST','action' => ['admin\AttributeFamilyContoller@store'], 'files' => true])}}
                                ...
                                <div id="{{$family->id}}edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            {{Form::model($cat,['method'=>'PATCH','action' => ['admin\AttributeFamilyContoller@update',$cat->id], 'files' => true])}}
                                                <div class="modal-body">
                                                    <div class="row">
                                    ...
                                    <div class="modal-dialog" style="width:55%;">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer" style="text-align:center">
                                                <form action="{{action('admin\AttributeFamilyContoller@destroy', $family['id'])}}" method="post">
                                                    {{csrf_field()}}
